...
import { GET_BEST_SELLER_BOOKS } from "../graphql/queries/book";
...
const BestSellers = () => {
  ...
  return (
    <div css={styles.container}>
      <h2 css={styles.title}>Best Sellers</h2>
      <Link to="/browse-books" css={styles.seeAllBtn}>
        <p>See All {" >>"}</p>
      </Link>
